            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img src="{{ asset('/assets/Images/Logo.png') }}" class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" style="height: 6vh; border-radius: 50%;" alt="OmniView" />
                    </a>
                </div>
