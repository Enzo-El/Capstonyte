                    ...
                    <tbody>
                        ...
                        @foreach ($customer as $customer)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('customersView/'.$customer->id.'')}}" type="button" class="btn btn-primary btn-sm" style="color:black">View</a>
                                    <a href="{{url('customerupdateview/'.$customer->id.'')}}" type="button" class="btn btn-secondary btn-sm" style="color:black">Edit</a>
                                    <a href="{{ route('customerdelete', [$customer->id]) }}" type="button" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to Delete this customer?')" style="color:black">Delete</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('customer.store') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary" name="addCustomer" style="color:black">Done</button>
